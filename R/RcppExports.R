...
grecond_plus <- function(I, w = 1.0, stop_threshold_ratio = 0.0, connection = "standard", logic_name = "Lukasiewicz") {
...
InClose_Reorder <- function(I, verbose = FALSE) {
    .Call(`_fcaR_InClose_Reorder`, I, verbose)
}
