# Contributing to fcaR

This outlines how to propose a change to fcaR. For more detailed info
...
Please note that the fcaR project is released with a [Contributor Code
of Conduct](https://neuroimaginador.github.io/fcaR/CODE_OF_CONDUCT.md).
