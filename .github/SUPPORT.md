# Getting help with fcaR

Thanks for using fcaR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/fcaR/issues) to make sure the 
